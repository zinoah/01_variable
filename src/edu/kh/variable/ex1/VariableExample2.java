...
public class VariableExample2 {
	public static void main(String[] args) {
		...
		// 자료형은 byte 변수명은 byteNumber 값 127 대입
		byte byteNumber = 127;
		...
		float floatNumber = 1.2345f; // F,f 접미
		
		double doubleNumber = 3.141592;
		//d를 뒤에 쓸 수는 있다. => 3.141592d;
		//실수형은 float, double 두 개밖에 없기 떄문에
		 ...
		 *   'B' 문자 그대로가 대입되면 변수에 숫자 66으로 변환되서 저장.
		 *   -->반대로 생각하면 변수에 애초에 66이라는 수사를 저장하는것이 가능.
		 * 
		 * */
